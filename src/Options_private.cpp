...
void option_register::setDefault(const char* aString) {
   ...
   if (aString == NULL) {
      ...
      strcpy_s(defaultOption, strlen(aString) + 1, aString);
   }
}
...
void option_register::setDefinition(const char* aString) {
   ...
   if (aString == NULL) {
	  ...
	  strcpy_s(definition, strlen(aString) + 1,aString);
   }
...
void option_register::setModified(const char* aString) {
   ...
   if (aString == NULL) {
      ...
      strcpy_s(modifiedOption,strlen(aString) + 1, aString);
   }
}
...
void option_list::setName(const char* aString) {
   ...
   strcpy_s(name, strlen(aString) + 1, aString);
}
